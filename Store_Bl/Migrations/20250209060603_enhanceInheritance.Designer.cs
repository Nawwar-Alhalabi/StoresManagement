...
namespace Store_Bl.Migrations
{
    ...
    [Migration("20250209060603_enhanceInheritance")]
    partial class enhanceInheritance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Store_Bl.Models.ItemsDelivered", b =>
                {
                    ...
                    b.ToTable("ItemsDelivered", t =>
                        {
                            t.HasTrigger("trg_AfterInsertDeliveryForm");
                        });
            ...
            modelBuilder.Entity("Store_Bl.Models.ItemsReceived", b =>
                {
                    ...
                    b.ToTable("ItemsReceived", t =>
                        {
                            t.HasTrigger("trg_AfterInsertReceiptForm");
                        });
